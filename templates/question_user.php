...
?>
<body>
		TODO:: break this file down into multiple components and require them.
	<div class="container section">
			...
			<div class="row">
				<div class="col-sm-8 blog-main">
					<div class="blog-post">
						...
						<a style="color:red;" href="/sha/staff/admin/questions/report.php?id=<?= $id; ?>">This post has <?= $reports_count; ?></a>
		...
		<?php if ($session->userCheck($user) || $session->adminCheck()) { 
				if ($session->adminCheck()) { ?>
					<a type="button" href="/sha/staff/admin/cms/questions/edit.php?id=<?= $id; ?>" class="btn btn-warning">Edit</a>
		<?php	} else { ?>
